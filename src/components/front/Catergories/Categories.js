...
import '../Catergories/Categories.css'
            ...
            <div className='Categories'>
                <Container>
                    <Row>
                        ...
                        <Col className='col-xl-4'>
                            <img src="../images/c-1.jpg" alt="image" className='size-img'/>
                        </Col>
                        <Col className='col-xl-4'>
                        ...
                        <Col className='col-xl-4'>
                            <img src="../images/c-4.jpg" alt="image"  className='size-img'/>
                        </Col>
                        <Col className='col-xl-4'>
                        ...
                        <Col className='col-xl-4'>
                            <img src="../images/c-5.jpg" alt="image"  className='size-img' />
                        </Col>
                        <Col className='col-xl-4'>
